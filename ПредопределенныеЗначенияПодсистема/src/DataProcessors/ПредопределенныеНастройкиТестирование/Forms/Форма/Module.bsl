...
Процедура ПроверитьЗначениеНастройки(ИмяНастройки, ТипЗначения, ЗначениеИсходное)
	...
	Если ТипЗначения = ПредопределенноеЗначение("Перечисление.ТипыЗначенияПредопределенныхЗначений.Строка")
		...
		Если Значение = ПредопределенныеНастройки.Значение(ИмяНастройки) Тогда
	...
	ИначеЕсли ТипЗначения = ПредопределенноеЗначение("Перечисление.ТипыЗначенияПредопределенныхЗначений.Массив") Тогда 
		...
		Если МассивыИдентичны(Значение, ПредопределенныеНастройки.Значение(ИмяНастройки)) Тогда
			УстановитьСтатусКнопки(Кнопка, Команда, Истина, НСтр("ru = 'Значение настройки проверено'"));
		Иначе 
			УстановитьСтатусКнопки(Кнопка, Команда, Ложь, НСтр("ru = 'Значение настройки не корректно'"));
		КонецЕсли;
	...
	ИначеЕсли ТипЗначения = ПредопределенноеЗначение("Перечисление.ТипыЗначенияПредопределенныхЗначений.ТаблицаЗначений")
		...
		Если Не КоллекцияРазличаются(Значение, ПредопределенныеНастройки.Значение(ИмяНастройки)) Тогда
			УстановитьСтатусКнопки(Кнопка, Команда, Истина, НСтр("ru = 'Значение настройки проверено'"));
		Иначе
			УстановитьСтатусКнопки(Кнопка, Команда, Ложь, НСтр("ru = 'Значение настройки не корректно'"));
		КонецЕсли;
