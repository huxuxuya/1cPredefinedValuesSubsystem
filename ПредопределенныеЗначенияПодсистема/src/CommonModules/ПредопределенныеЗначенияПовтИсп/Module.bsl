...
Функция СсылкаПредопределенногоЭлемента(ИмяПредопределенного) Экспорт
	...
	Описание = ОписаниеНастройкиПоИмени(ИмяПредопределенного);
	
	Если Описание = Неопределено Тогда
		Возврат ПредопределенноеЗначение("Справочник.ПредопределенныеЗначения.ПустаяСсылка");
	КонецЕсли;
	
	Идентификатор = Новый УникальныйИдентификатор(Описание.Идентификатор);
	
	Ссылка = Справочники.ПредопределенныеЗначения.ПолучитьСсылку(Идентификатор);
