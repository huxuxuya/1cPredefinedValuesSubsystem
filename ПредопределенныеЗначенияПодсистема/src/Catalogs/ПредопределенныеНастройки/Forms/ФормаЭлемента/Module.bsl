...
Процедура УстановитьПодсказкуПрограммногоДобавления()
	...
	ШаблонДобавленияЭлемента = НСтр("ru = 'Настройка ""%1"" добавлена программно.'");
	
	Объект.Описание = БазоваяФункциональностьКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонДобавленияЭлемента, Объект.ИмяНастройки);
